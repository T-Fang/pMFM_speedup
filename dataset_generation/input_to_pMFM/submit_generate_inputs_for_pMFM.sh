...
job_err="/home/ftian/storage/pMFM_speedup/dataset_generation/input_to_pMFM/job/input_to_pMFM_err.txt"
job_out="/home/ftian/storage/pMFM_speedup/dataset_generation/input_to_pMFM/job/input_to_pMFM_out.txt"

MATLAB=$(which matlab)

cmd="$MATLAB -nosplash -nodisplay -nodesktop -r "
cmd="${cmd} \"addpath('/home/ftian/storage/pMFM_speedup/dataset_generation/input_to_pMFM'); generate_inputs_wrapper; quit;\" "
